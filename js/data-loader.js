...
const DataLoader = {
  ...
  async loadCategories() {
    ...
    try {
      const res = await fetch('data/categories.json?v=13');
  ...
  async loadQuestions(chapterId) {
    ...
    let result;
    try {
      const res = await fetch(`data/questions/${chapterId}.json?v=13`);
      if (!res.ok) {
  ...
  async loadBank() {
    ...
    try {
      const res = await fetch('data/question-bank.json?v=13');
  ...
  async loadSubjectQuestions(subjectId) {
    ...
    try {
      const res = await fetch(`data/subjects/${subjectId}.json?v=13`);
      if (!res.ok) {
